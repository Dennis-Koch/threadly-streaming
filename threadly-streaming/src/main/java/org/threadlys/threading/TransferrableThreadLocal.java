...
public interface TransferrableThreadLocal<T> {
     ...
     * forked threads while executing {@link ContextSnapshotController#pushContext(org.threadlys.threading.impl.ContextSnapshotImpl, org.threadlys.utils.IStateRevert...)}
     ...
     */
    IStateRevert setForFork(T newForkedValue, T oldForkedValue);
}
